...
class DeviceRepositoryImpl(
    ...
    private suspend fun fetchDeviceInfo(deviceId: String): DeviceInfo? {
        return try {
    ...
    private suspend fun getProperty(deviceId: String, property: String): String? {
    ...
    private suspend fun getScreenInfo(deviceId: String, command: String, prefix: String): String? {
