...
- **Kotlin** – Gradle plugin updated from 2.3.20 to 2.3.21
- **Gradle** – Wrapper updated from 9.4.1 to 9.5.0
- **IntelliJ Platform Gradle plugin** – Updated from 2.13.1 to 2.16.0
